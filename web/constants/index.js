...
export const WEATHER_API = `${EGG_SERVER}/v0.1/weathers`;
export const COOKIE = {
  USER_NAME: "USER_NAME",
...
export const links = [
  ...
  {
    href: "http://hetenghuan.greatwebtech.cn/jenkins",
    text: "jenkins",
    page: "other",
  },
  {
    href: "http://code-craft.greatwebtech.cn/",
    text: "code-craft",
    page: "other",
  },
  ...
  {
    href: "http://handsontable.greatwebtech.cn/",
    text: "云表格",
    page: "other",
  },
  {
    href: "http://hanxiaoluan.greatwebtech.cn/",
    text: "reactApp",
    page: "other",
  },
];
